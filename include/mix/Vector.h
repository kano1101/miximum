...
namespace Mix
{
  ...
  struct Dimension { public: typedef double ComponentType; };
  struct Dimension1D : Dimension { protected: ComponentType x_; };
  struct Dimension2D : Dimension1D { protected: ComponentType y_; };
  struct Dimension3D : Dimension2D { protected: ComponentType z_; };
  struct Dimension4D : Dimension3D { protected: ComponentType w_; };
  ...
  public:
    ...
    typedef typename DimensionND::ComponentType ComponentType;

    ComponentType X() const { return this->x_; }
    ComponentType Y() const { return this->y_; }
    ComponentType Z() const { return this->z_; }
    ComponentType W() const { return this->w_; }
    ...
    explicit Vector(ComponentType x = 0.0, ComponentType y = 0.0, ComponentType z = 0.0, ComponentType t = 0.0)
    {
      Initialize(x, y, z, t, Loki::Type2Type<DimensionND>());
    }

    void Initialize(ComponentType x, ComponentType y, ComponentType z, ComponentType t, Loki::Type2Type<Dimension1D>)
    {
      this->x_ = x; UNUSED(y); UNUSED(z); UNUSED(t);
    }
    void Initialize(ComponentType x, ComponentType y, ComponentType z, ComponentType t, Loki::Type2Type<Dimension2D>)
    {
      this->x_ = x; this->y_ = y; UNUSED(z); UNUSED(t);
    }
    void Initialize(ComponentType x, ComponentType y, ComponentType z, ComponentType t, Loki::Type2Type<Dimension3D>)
    {
      this->x_ = x; this->y_ = y; this->z_ = z; UNUSED(t);
    }
    void Initialize(ComponentType x, ComponentType y, ComponentType z, ComponentType t, Loki::Type2Type<Dimension4D>)
    {
      this->x_ = x; this->y_ = y; this->z_ = z; this->w_ = t;
    }

    void Reset(ComponentType x = 0.0, ComponentType y = 0.0, ComponentType z = 0.0, ComponentType t = 0.0) { this->Reset(Vector(x, y, z, t)); }
    void Move(ComponentType x = 0.0, ComponentType y = 0.0, ComponentType z = 0.0, ComponentType t = 0.0) { this->Move(Vector(x, y, z, t)); }
    ...
    ComponentType GetLength() const { return GetLength(Loki::Type2Type<DimensionND>()); }
    ...
    ComponentType GetLength(Loki::Type2Type<Dimension1D>) const
    {
      return abs(this->x_);
    }
    ComponentType GetLength(Loki::Type2Type<Dimension2D>) const
    {
      return sqrt(this->x_ * this->x_ + this->y_ * this->y_);
    }
    ComponentType GetLength(Loki::Type2Type<Dimension3D>) const
    {
      return sqrt(this->x_ * this->x_ + this->y_ * this->y_ + this->z_ * this->z_);
    }
    ComponentType GetLength(Loki::Type2Type<Dimension4D>) const
    {
    ...
    Vector GetUnit(ComponentType len, Loki::Type2Type<Dimension1D>) const
    {
      return Vector(this->x_ / len);
    }
    Vector GetUnit(ComponentType len, Loki::Type2Type<Dimension2D>) const
    {
      return Vector(this->x_ / len, this->y_ / len);
    }
    Vector GetUnit(ComponentType len, Loki::Type2Type<Dimension3D>) const
    {
      return Vector(this->x_ / len, this->y_ / len, this->z_ / len);
    }
    Vector GetUnit(ComponentType len, Loki::Type2Type<Dimension4D>) const
    {
      return Vector(this->x_ / len, this->y_ / len, this->z_ / len, this->w_ / len);
    }

    ComponentType GetInner(const Vector2D & v) const { return (this->x_ * v.x_ + this->y_ * v.y_); }  //ベクトル内積計算
    ComponentType GetCross(const Vector2D & v) const { return (this->x_ * v.y_ - v.x_ * this->y_); }  //ベクトル外積計算
